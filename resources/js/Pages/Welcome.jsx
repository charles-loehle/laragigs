...
export default function Welcome(props) {
    ...
    const styles = { backgroundImage: laravelLogo };
    ...
    return (
        <>
            ...
            <div className="min-h-screen sm:items-center sm:pt-0">
                <nav className="px-6 py-4 sm:block">
                    {props.auth.user ? (
                        <div className="flex justify-between items-center mb-4">
                            <div className="logo flex justify-center pt-8 sm:justify-start sm:pt-0">
                                <svg
                                    viewBox="0 0 651 192"
                                    fill="none"
                ...
                <section className="hero bg-red-500 relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
                    <div
                            ...
                            >
                                <div className="flex">
                                    <img
                                        ...
                                        src={`${location}/storage/${listing.logo}`}
                                        alt=""
                                    />
                                    <div>
